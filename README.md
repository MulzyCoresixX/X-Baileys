...
![WhatsApp API](https://files.catbox.moe/2vu0bo.jpg)
...
```bash
npm install @MulzyCoresiX/X-Baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @MulzyCoresiX/X-Baileys@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@MulzyCoresiX/X-Baileys")
```
# Links
...
```javascript
const makeWASocket = require("@MulzyCoresiX/X-Baileys").default;
const { useMultiFileAuthState } = require("@MulzyCoresiX/X-Baileys");
...
```javascript
const makeWASocket = require("@MulzyCoresiX/X-Baileys").default;
const { useMultiFileAuthState, makeCacheableSignalKeyStore } = require("@MulzyCoresiX/X-Baileys");
...
```javascript
const makeWASocket = require("@MulzyCoresiX/X-Baileys").default;
const { DisconnectReason, useMultiFileAuthState } = require("@MulzyCoresiX/X-Baileys");
...
```javascript
const makeWASocket = require("@MulzyCoresiX/X-Baileys").default;
const { makeInMemoryStore } = require("@MulzyCoresiX/X-Baileys");
...
const { downloadMediaMessage, getContentType } = require("@MulzyCoresiX/X-Baileys");
